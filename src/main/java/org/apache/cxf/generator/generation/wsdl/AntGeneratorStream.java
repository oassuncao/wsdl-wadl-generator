 ...
 * @since 1.0
 */
public class AntGeneratorStream extends AntGenerator implements WriterResult {
// ------------------------------ FIELDS ------------------------------
...
// --------------------------- CONSTRUCTORS ---------------------------
    ...
    public AntGeneratorStream() {
        this(new ArrayList<>());
    }

    public AntGeneratorStream(List<GeneratorResult> results) {
