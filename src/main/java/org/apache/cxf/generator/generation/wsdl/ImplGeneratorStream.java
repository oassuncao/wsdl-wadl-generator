 ...
 * @since 1.0
 */
public class ImplGeneratorStream extends ImplGenerator implements WriterResult {
// ------------------------------ FIELDS ------------------------------
...
// --------------------------- CONSTRUCTORS ---------------------------
    ...
    public ImplGeneratorStream() {
        this(new ArrayList<>());
    }

    public ImplGeneratorStream(List<GeneratorResult> results) {
