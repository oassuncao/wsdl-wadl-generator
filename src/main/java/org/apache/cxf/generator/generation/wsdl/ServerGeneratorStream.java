...
import org.apache.cxf.tools.wsdlto.frontend.jaxws.generators.ServerGenerator;
 ...
 * @since 1.0
 */
public class ServerGeneratorStream extends ServerGenerator implements WriterResult {
// ------------------------------ FIELDS ------------------------------
...
// --------------------------- CONSTRUCTORS ---------------------------
    ...
    public ServerGeneratorStream() {
        this(new ArrayList<>());
    }

    public ServerGeneratorStream(List<GeneratorResult> results) {
